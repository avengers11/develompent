            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="<?php echo e(url('#')); ?>">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="<?php echo e(route('admin.settings.frontend.menuheader')); ?>" class="slide-item"><?php echo e(__('Menu and Header\'s')); ?></a></li>
                        <li><a href="<?php echo e(route('admin.settings.frontend.services')); ?>" class="slide-item"><?php echo e(__('Service\'s')); ?></a></li>
                        <li><a href="<?php echo e(route('admin.settings.frontend.futureai')); ?>" class="slide-item"><?php echo e(__('Future of AI')); ?></a></li>
                        <li><a href="<?php echo e(route('admin.settings.frontend.pentaforceai')); ?>" class="slide-item"><?php echo e(__('Penta Force Ai')); ?></a></li>
                        <li><a href="<?php echo e(route('admin.settings.frontend.howwork')); ?>" class="slide-item"><?php echo e(__('How Does It Work')); ?></a></li>
                        <li><a href="<?php echo e(route('admin.settings.frontend.footer')); ?>" class="slide-item"><?php echo e(__('Footer')); ?></a></li>
                        <li><a href="<?php echo e(route('admin.settings.frontend.loginSignup')); ?>" class="slide-item"><?php echo e(__('Login Signup')); ?></a></li>
                        <li><a href="<?php echo e(route('admin.settings.page')); ?>" class="slide-item"><?php echo e(__('Privacy Policy, Terms & Conditions, Cookies')); ?></a></li>
...
<!-- END SIDE MENU BAR -->
<?php /**PATH C:\laragon\www\Laravel\51_pentaforce\resources\views/layouts/nav-aside.blade.php ENDPATH**/ ?>