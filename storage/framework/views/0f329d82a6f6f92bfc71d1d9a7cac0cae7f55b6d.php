    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(asset(site()['favicons'])); ?>" class="header-brand-img desktop-lgo" alt="Polly logo">
                <img src="<?php echo e(asset(site()['favicons'])); ?>" class="header-brand-img mobile-logo" alt="Polly logo">
            </a>
...
<!-- END TOP MENU BAR -->
<?php /**PATH C:\laragon\www\Laravel\51_pentaforce\resources\views/layouts/nav-top.blade.php ENDPATH**/ ?>