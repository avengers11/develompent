<!--Favicon -->
<link rel="icon" href="<?php echo e(asset(site()['favicons'])); ?>" type="image/x-icon"/>
...
<?php /**PATH C:\laragon\www\Laravel\51_pentaforce\resources\views/layouts/header.blade.php ENDPATH**/ ?>