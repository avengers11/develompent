    ...
    <div class="container text-white md:flex">
        <div class="text-center md:text-left py-9 md:w-1/2 ">
            ...
            <p
                ...
                <?php echo e(site_content('service_description')); ?>

            </p>
        </div>
        <div class="relative w-1/2 overflow-visible">
            <img src="<?php echo e(asset('/images/the-future-of-ai-mobile.png')); ?>" alt="<?php echo e(site_content('service_title')); ?>"
...
<?php /**PATH C:\laragon\www\Laravel\51_pentaforce\resources\views/components/intro-section.blade.php ENDPATH**/ ?>