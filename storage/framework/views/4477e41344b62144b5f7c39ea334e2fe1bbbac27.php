						...
						<div class="container-tight">
							...
							<form novalidate="novalidate" onsubmit="return RegisterForm();">
								...
								<div class="row mt-[35px]">
									<div class="col">
										<button id="RegisterFormButton" class="md:ml-0 md:mb-[43px] m-auto w-max bg-gradient-to-l from-teal-400 to-emerald-500 rounded-full mt-14 md:mt-10 flex gap-2 items-center px-6 py-2 lg:mb-6 font-semibold text-white btn btn-primary w-100"><?php echo e(__('Sign up')); ?></button>
									</div>
								</div>
							</form>
						</div>
...
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\Laravel\51_pentaforce\resources\views/auth/register.blade.php ENDPATH**/ ?>