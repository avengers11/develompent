...
<nav class="py-4">
    <div class="container flex justify-between items-center !py-2 relative">
        ...
        <a href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(asset(site()['primary_logo'])); ?>" alt="<?php echo e(config('app.name')); ?>" class="w-[100px] md:w-[120px] lg:w-[140px]">
        </a>
        ...
        <div class="flex items-center xl:!pr-[49px] 2xl:!pr-[40px]">
            ...
            <div class="hidden gap-4 mr-4 font-medium lg:flex text-zinc-800">
                <?php $__currentLoopData = site_content('navMenus'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="#section-<?php echo e($loop->iteration); ?>"
                        class="px-2 py-1 rounded-md hover:bg-gradient-to-l from-teal-400 to-emerald-500 hover:text-white"><?php echo e($item); ?></a>
            ...
            <a href="<?php echo e(route('register')); ?>"
                ...
                <?php echo app('translator')->get('Join Hub'); ?>
            </a>
            ...
            <div class="relative flex items-center">
                <?php if(count($languages) > 1): ?>
                    ...
                    <div class="absolute language-dropdown w-max right-0 top-[145%] bg-white shadow-lg">
                        <?php $__currentLoopData = $locales->only($languages); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang => $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(LaravelLocalization::getLocalizedURL($lang, null, [], true)); ?>"
                                class="flex justify-center px-4 py-2 text-lg font-normal border border-gray-200 text-zinc-800"><?php echo e($locale['name']); ?></a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php endif; ?>
            </div>
        ...
        <div class="absolute burger-dropdown w-full left-0 top-[102%] bg-white shadow-lg z-50">
            <?php $__currentLoopData = site_content('navMenus'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="#section-<?php echo e($loop->iteration); ?>"
                    class="flex justify-center py-2 text-lg font-normal border border-gray-200 text-zinc-800"><?php echo e($item); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <a href="<?php echo e(route('register')); ?>"
                class="flex justify-center py-2 text-lg font-normal border-b border-gray-200 text-neutral-500 md:hidden"><?php echo app('translator')->get('Join Hub'); ?></a>
        </div>
    </div>
</nav>
...
<?php /**PATH C:\laragon\www\Laravel\51_pentaforce\resources\views/components/navigation.blade.php ENDPATH**/ ?>