...
use App\Http\Controllers\Admin\Frontend\WebFrontendController;
...
Route::controller(HomeController::class)->group(function () {
    ...
    Route::get('/cookies', 'pageCookies');
    Route::get('/terms-and-conditions', 'pageTerms');
    Route::get('/privacy-policy', 'pagePrivacy');
});
...
Route::group(['prefix' => 'admin', 'middleware' => ['verified', '2fa.verify', 'role:admin', 'PreventBackHistory']], function () {
    ...
    // ADMIN FRONTEND SETTINGS - FRONTEND SETTINGS
    Route::controller(WebFrontendController::class)->group(function () {
        Route::get('/settings/frontend/menu-header', 'menuHeaders')->name('admin.settings.frontend.menuheader');

        // services
        Route::get('/settings/frontend/services', 'services')->name('admin.settings.frontend.services');
        Route::get('/settings/frontend/servicesadd', 'servicesAdd')->name('admin.settings.frontend.servicesadd');
        Route::get('/settings/frontend/servicesupdate/{id}', 'servicesUpdate')->name('admin.settings.frontend.servicesupdate');

        // futureai
        Route::get('/settings/frontend/futureai', 'futureAi')->name('admin.settings.frontend.futureai');
        Route::get('/settings/frontend/futureai-sl-add', 'futureAiSlAdd')->name('admin.settings.frontend.futureaisladd');
        Route::get('/settings/frontend/futureai-sl-update/{id}', 'futureAiSlUpdate')->name('admin.settings.frontend.futureaislupdate');

        // pentaforceai
        Route::get('/settings/frontend/pentaforceai', 'pentaforceai')->name('admin.settings.frontend.pentaforceai');
        Route::get('/settings/frontend/pentaforceaiadd', 'pentaforceAiAdd')->name('admin.settings.frontend.pentaforceaiadd');
        Route::get('/settings/frontend/pentaforceaiupdate/{id}', 'pentaforceAiUpdate')->name('admin.settings.frontend.pentaforceaiupdate');

        Route::get('/settings/frontend/howwork', 'howwork')->name('admin.settings.frontend.howwork');
        Route::get('/settings/frontend/footer', 'footer')->name('admin.settings.frontend.footer');
        Route::get('/settings/frontend/loginSignup', 'loginSignup')->name('admin.settings.frontend.loginSignup');
        /*
        ===========================================================
        BACKEND
        ===========================================================
        */
        // menu-header
        Route::post('/settings/frontend/menu-header', 'menuHeadersPost')->name('admin.settings.frontend.menuheader');

        // services
        Route::post('/settings/frontend/servicestitle', 'servicesTitle')->name('admin.settings.frontend.servicestitle');
        Route::post('/settings/frontend/servicesadd', 'servicesAddPost')->name('admin.settings.frontend.servicesadd');
        Route::post('/settings/frontend/servicesupdate', 'servicesUpdatePost')->name('admin.settings.frontend.servicesupdatepost');
        Route::get('/settings/frontend/servicesdelete/{id}', 'servicesDeletePost')->name('admin.settings.frontend.servicesdelete');

        // futureai
        Route::post('/settings/frontend/futureaiclradd', 'futureaiClrAddPost')->name('admin.settings.frontend.futureaiclraddPost');
        Route::get('/settings/frontend/futureaiclrdelete/{id}', 'futureaiClrDelete')->name('admin.settings.frontend.futureaiclrdelete');
        Route::post('/settings/frontend/futureaisladd', 'futureaiSlAddPost')->name('admin.settings.frontend.futureaisladdpost');
        Route::get('/settings/frontend/futureaisldelete/{id}', 'futureaiSlDelete')->name('admin.settings.frontend.futureaisldelete');
        Route::post('/settings/frontend/futureaislupdate', 'futureaiSlupdatePost')->name('admin.settings.frontend.futureaislupdatepost');

        // pentaforceai
        Route::post('/settings/frontend/pentaforceaides', 'pentaForceaiDesPost')->name('admin.settings.frontend.pentaforceaidespost');
        Route::post('/settings/frontend/pentaforceadd', 'pentaForceAddPost')->name('admin.settings.frontend.pentaforceaddpost');
        Route::get('/settings/frontend/pentaforcedelete/{id}', 'pentaForceDelete')->name('admin.settings.frontend.pentaforcedelete');
        Route::post('/settings/frontend/pentaforceupdate', 'pentaForceUpdatePost')->name('admin.settings.frontend.pentaforceupdatepost');

        // howwork
        Route::post('/settings/frontend/howworkdes', 'howworkdes')->name('admin.settings.frontend.howworkdes');
        Route::post('/settings/frontend/howworkadd', 'howworkadd')->name('admin.settings.frontend.howworkadd');
        Route::post('/settings/frontend/howworkupdate/{key}', 'howworkupdate')->name('admin.settings.frontend.howworkupdate');
        Route::get('/settings/frontend/howworkdelete/{key}', 'howworkDelete')->name('admin.settings.frontend.howworkdelete');

        // footer
        Route::post('/settings/frontend/footernavmenu', 'footerNavMenu')->name('admin.settings.frontend.footernavmenu');
        Route::post('/settings/frontend/footermenu', 'footerMenu')->name('admin.settings.frontend.footermenu');
        Route::post('/settings/frontend/footermenuicons', 'footerMenuIcons')->name('admin.settings.frontend.footermenuicons');

        // loginSignup
        Route::post('/settings/frontend/loginSignupPost', 'loginSignupPost')->name('admin.settings.frontend.loginSignupPost');
    });
    ...
    Route::controller(PageController::class)->group(function () {
        Route::get('/settings/page', 'indexPage')->name('admin.settings.page');
        Route::post('/settings/page', 'storePage')->name('admin.settings.page.store');
        
        // Route::get('/settings/privacy', 'indexPrivacy')->name('admin.settings.privacy');
        // Route::post('/settings/privacy', 'storePrivacy')->name('admin.settings.privacy.store');
        // Route::get('/settings/cookies', 'indexCookies')->name('admin.settings.cookies');
        // Route::post('/settings/cookies', 'storeCookies')->name('admin.settings.cookies.store');
    });
