<!DOCTYPE html>
<html lang="@php \Mcamara\LaravelLocalization\Facades\LaravelLocalization::getCurrentLocale() @endphp" dir="@php \Mcamara\LaravelLocalization\Facades\::getCurrentLocaleDirection() @endphp" class="max-sm:overflow-x-hidden">
<head>
