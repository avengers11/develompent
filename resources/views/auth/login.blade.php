        ...
        <div class="row items-stretch min-h-[100vh]">
            ...
            <div style="background: #ECEAEA; gap:18vh" class="flex flex-col justify-start col-lg-5 trr">
                ...
                <div class="items-center p-8 row max-lg:px-1">
                    <div class="col-6 justify-start d-flex">
                        <a href="{{ route('index') }}" class="navbar-brand flex justify-center">
                            <img src="{{asset(site()['primary_logo'])}}" @if (isset($information['logo_2x_path'])) srcset="/{{ $information['logo_2x_path']; }} 2x" @endif alt="{{ $information['site_name']; }}" class="w-[100px] md:w-[120px] lg:w-[140px] group-[.navbar-shrinked]/body:hidden dark:hidden">
                        </a>
                    </div>
                ...
                <div class="row">
                    <div class="mx-auto col-lg-6">
                        <h1 class="m:text-center mb-11">{{ __('Sign in') }}</h1>
                        @if ($information['github_active'] || $information['twitter_active'] || $information['google_active'] || $information['facebook_active'])
                            <div class="flex flex-wrap !gap-4 text-[13px] -tracking-[0.15px]]">
                                @if ($information['google_active'])
                                ...
                                @endif
                                @if ($information['facebook_active'])
                            ...
                            <div class="row">
                                <div class="col">
                                    <label class="form-check form-check-inline">
                                        ...
                                        <span class="form-check-label remember_me">{{ __('Remember me') }}</span>
                                    </label>
                                </div>
                                <div class="col !text-end">
                                    <a class="forget" href="{{route('password.request')}}">{{ __('Forgot Password?') }}</a>
                                </div>
                            </div>
                            <div class="row mt-[25px]">
                                <div class="col">
                                    <button id="LoginFormButton"
                                        class="md:ml-0 md:mb-[43px] m-auto w-max bg-gradient-to-l from-teal-400 to-emerald-500 rounded-full mt-14 md:mt-10 flex gap-2 items-center px-6 py-2 lg:mb-6 font-semibold text-white btn btn-primary w-100">{{ __('Sign in') }}</button>
                                </div>
                            </div>
                            <!-- TODO Openai Demo -->
                        ...
                        @if ($information['privacy_enable'] == 1 && $information['privacy_enable_login'] == 1)
                        ...
                        @endif
                        @if ($information['register_active'] == 1)
                            <div class="mt-10 mb-10 text-center text-muted">
            ...
            <div class="flex flex-col justify-between overflow-hidden bg-center bg-cover col-lg-7 max-lg:hidden" style="background: linear-gradient(#09ADA0 100%, #2EDEB6 100%);">
                <div id="icons_wrapper_f">
                    <a target="_BLANK" href="{{ $webSiteContent['lnsp_bminl_1'] }}" class="wrap">
                        <img class="logo" src="{{ asset($webSiteContent['lnsp_bmin_1']) }}" alt="">
                    </a>

                    <a target="_BLANK" href="{{ $webSiteContent['lnsp_bminl_2'] }}" class="wrap">
                        <img class="logo" src="{{ asset($webSiteContent['lnsp_bmin_2']) }}" alt="">
                    </a>

                    <a target="_BLANK" href="{{ $webSiteContent['lnsp_bminl_3'] }}" class="wrap">
                        <img class="logo" src="{{ asset($webSiteContent['lnsp_bmin_3']) }}" alt="">
                    </a>

                    <a target="_BLANK" href="{{ $webSiteContent['lnsp_bminl_4'] }}" class="wrap">
                        <img class="logo" src="{{ asset($webSiteContent['lnsp_bmin_4']) }}" alt="">
                    </a>

                    <a target="_BLANK" href="{{ $webSiteContent['lnsp_bminl_5'] }}" class="wrap">
                        <img class="logo" src="{{ asset($webSiteContent['lnsp_bmin_5']) }}" alt="">
                    </a>
                </div>
                <div class="container">
                    <img style="height: auto; width:100%" src="{{ asset('assets\img\login\cover.png') }}" alt="MagicAI Dashboard Mockup">
                </div>
            </div>
        </div>
    </div>
