    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand" href="{{ url('/') }}">
                <img src="{{asset(site()['favicons'])}}" class="header-brand-img desktop-lgo" alt="Polly logo">
                <img src="{{asset(site()['favicons'])}}" class="header-brand-img mobile-logo" alt="Polly logo">
            </a>
