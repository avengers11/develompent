...
<aside class="app-sidebar">
    <div class="app-sidebar__logo">
        <a class="header-brand" href="{{url('/')}}">
            <img style="height: 3.5rem !important" src="{{asset(site()['primary_logo'])}}" class="header-brand-img desktop-lgo" alt="Admintro logo">
            <img style="height: 3.5rem !important" src="{{asset(site()['primary_logo'])}}" class="header-brand-img mobile-logo" alt="Admintro logo">
        </a>
    </div>
            ...
            <li class="slide">
                <a class="side-menu__item" data-toggle="slide" href="{{ url('#')}}">
                    ...
                    <ul class="slide-menu">
                        ...
                        <li><a href="{{ route('admin.settings.frontend.menuheader') }}" class="slide-item">{{__('Menu and Header\'s')}}</a></li>
                        <li><a href="{{ route('admin.settings.frontend.services') }}" class="slide-item">{{__('Service\'s')}}</a></li>
                        <li><a href="{{ route('admin.settings.frontend.futureai') }}" class="slide-item">{{__('Future of AI')}}</a></li>
                        <li><a href="{{ route('admin.settings.frontend.pentaforceai') }}" class="slide-item">{{__('Penta Force Ai')}}</a></li>
                        <li><a href="{{ route('admin.settings.frontend.howwork') }}" class="slide-item">{{__('How Does It Work')}}</a></li>
                        <li><a href="{{ route('admin.settings.frontend.footer') }}" class="slide-item">{{__('Footer')}}</a></li>
                        <li><a href="{{ route('admin.settings.frontend.loginSignup') }}" class="slide-item">{{__('Login Signup')}}</a></li>
                        <li><a href="{{ route('admin.settings.page') }}" class="slide-item">{{__('Privacy Policy, Terms & Conditions, Cookies')}}</a></li>
